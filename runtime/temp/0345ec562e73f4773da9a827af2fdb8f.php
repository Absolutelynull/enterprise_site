<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\auth_group\edit.htm";i:1558768407;s:80:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\top.htm";i:1557647847;s:81:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\left.htm";i:1558427229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="username"
                                                   class="col-sm-2 control-label no-padding-right">用户组标题</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="title" required="" value="<?php echo $auth['title']; ?>"
                                                       type="text">
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    <input class="checkbox-slider  colored-blue"
                                                           ...
                                                           type="checkbox" value="1" <?php if($auth['status'] == 1): ?> checked="checked"<?php endif; ?>>
                                                                ...
                                                                <label>
                                                                    ...
                                                                    <input
                                                                        <?php
                                                                           ...
                                                                           if(in_array($authRule['id'],$arr)){echo 'checked="checked"';}
                                                                         ?>
                                                                            name="rules[]" value="<?php echo $authRule['id']; ?>" dataid="id-<?php echo $authRule['id']; ?>" class="checkbox-parent <?php if($authRule['level'] != 0): ?>checkbox-child<?php endif; ?>"
                                                                    type="checkbox"
                                                                    checked="checked"
                                                                    value="true">
