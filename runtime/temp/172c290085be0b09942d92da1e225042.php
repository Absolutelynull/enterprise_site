<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\cate\lst.htm";i:1557821495;s:80:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\top.htm";i:1557647847;s:81:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\left.htm";i:1558427229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <input type="text" style="width: 50px" value="<?php echo $cate['sort']; ?>"
                                                           name="<?php echo $cate['id']; ?>">
                                                </td>
                                                <td>
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo url('edit',['id'=>$cate['id']]); ?>"
                                                       class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#"
                                                       onClick="warning('确实要删除吗', '<?php echo url('delete',['id'=>$cate['id']]); ?>')"
