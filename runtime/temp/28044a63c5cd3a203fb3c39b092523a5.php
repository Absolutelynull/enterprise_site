<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\cate\edit.htm";i:1559373624;s:80:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\top.htm";i:1557647847;s:81:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\left.htm";i:1558427229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="pid">
                                                    ...
                                                    <option value="<?php echo $catename['id']; ?>" <?php if($catename['pid'] == $cate['id']): ?>selected="selected"<?php endif; ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="name" required=""
                                                   value="<?php echo $cate['name']; ?>"    type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="control-group">
                                                    <div class="radio"><label><input <?php if($cate['type'] == 1): ?>checked="checked"<?php endif; ?> name="type"
                                                                                     value="1" type="radio"><span
                                                            class="text">列表</span></label></div>
                                                    <div class="radio"><label><input class="inverted" t <?php if($cate['type'] == 2): ?>checked="checked"<?php endif; ?> name="type"
                                                                                     value="2" type="radio"><span
                                                            class="text">单页</span></label></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label><input name="cate_rec" <?php if($cate['cate_rec'] == 1): ?>checked="checked" <?php endif; ?>
                                                              type="radio" value="1"><span class="text">推荐</span></label>
                                                <label><input name="cate_rec" <?php if($cate['cate_rec'] == 0): ?>checked="checked" <?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label><input name="cate_bottom_rec" <?php if($cate['cate_bottom_rec'] == 1): ?>checked="checked" <?php endif; ?>
                                                              type="radio" value="1"><span class="text">推荐</span></label>
                                                <label><input name="cate_bottom_rec" <?php if($cate['cate_bottom_rec'] == 0): ?>checked="checked" <?php endif; ?>
                                                              type="radio" value="0"><span class="text">不推荐</span></label>
                                            </div>
                                        </div>
