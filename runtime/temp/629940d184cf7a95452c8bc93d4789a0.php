<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\article\add.htm";i:1559377855;s:80:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\top.htm";i:1557647847;s:81:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\left.htm";i:1558427229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label><input name="index_rec"
                                                              type="radio" value="1"><span class="text">推荐</span></label>
                                                <label><input checked="checked" name="index_rec"
