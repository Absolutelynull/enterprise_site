<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\article\edit.htm";i:1559377916;s:80:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\top.htm";i:1557647847;s:81:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\left.htm";i:1558427229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="author" required=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="keywords" required=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="desc" class="form-control" id="" cols="30"
                                                          rows="3"><?php echo $article['desc']; ?></textarea>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <?php if($article['pic'] != ''): ?>
                                                <img src="__ADMIN__/uploads/<?php echo $article['pic']; ?>" height="50px" width="50px"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cateid">
                                                    ...
                                                    <option value="<?php echo $cate['id']; ?>" <?php if($cate['id'] == $article['cateid']): ?>selected="selected"
                                                            <?php endif; ?>>
                                                    <?php if($cate['level'] != 0): ?>|<?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">首页推荐&nbsp;&nbsp;</label>
                                            <div class="radio">
                                                <label><input name="index_rec" <?php if($article['index_rec'] == 1): ?>checked="checked"<?php endif; ?>
                                                              type="radio" value="1"><span class="text">推荐</span></label>
                                                <label><input  name="index_rec" <?php if($article['index_rec'] == 0): ?>checked="checked"<?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="content" id="content" cols="0" rows="0"><?php echo $article['content']; ?></textarea>
                                            </div>
                                        </div>
