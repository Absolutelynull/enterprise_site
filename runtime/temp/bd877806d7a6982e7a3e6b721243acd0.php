<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\auth_group\lst.htm";i:1558428009;s:80:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\top.htm";i:1557647847;s:81:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\left.htm";i:1558427229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <button class="btn btn-azure btn-xs" type="button">启用</button>
                                                <?php else: ?>
                                                <button class="btn btn-darkorange btn-xs" type="button">禁止</button>
                                                <?php endif; ?>
                                            </td>
                                            <td align="center">
                                                <a href="<?php echo url('edit',['id'=>$auth['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url('delete',['id'=>$auth['id']]); ?>')"
