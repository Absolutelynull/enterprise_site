<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\auth_rule\edit.htm";i:1558691661;s:80:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\top.htm";i:1557647847;s:81:"C:\phpStudy\PHPTutorial\WWW\birk\public/../application/admin\view\common\left.htm";i:1558427229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="username"
                                                   class="col-sm-2 control-label no-padding-right">上级权限</label>
                                            <div class="col-sm-6">
                                                <select name="pid">
                                                    ...
                                                    <option <?php if($authRule['pid'] == $authRule['id']): ?> selected="selected"<?php endif; ?> value="<?php echo $authRule['id']; ?>">
                                                        <?php echo $authRule['pid']; ?>-><?php echo $authRule['id']; if($authRule['level'] != 0): ?>|<?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">权限名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="title" required=""
                                                       type="text" value="<?php echo $authRules['title']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">控/方</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder=""
                                                       name="name" required="" value="<?php echo $authRules['name']; ?>"
                                                       type="text">
                                            </div>
                                        </div>
